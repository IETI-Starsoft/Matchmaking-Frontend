            ...
            <Box>
                ...
                <Box className={classes.top} borderBottom={1}>
                        ...
                        <Box className={classes.centerContainer}>
                            <Typography className={classes.nameTop} >
                                {name}
                            </Typography>
